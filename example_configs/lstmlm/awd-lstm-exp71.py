...
data_root = "/data/wikitext-2-raw/"
processed_data_folder = '/data/wkt2-processed-data'
...
base_params = {
  ...
  "batch_size_per_gpu": 320, # conforming to AWD-LSTM paper 80
